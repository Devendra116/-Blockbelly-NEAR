...
impl Contract {
    ...
    #[init]
    pub fn new_default_meta(owner_id: AccountId, total_supply: U128,token_list:Vec<String>,token_alloc:Vec<String>) -> Self {
        Self::new(
            owner_id,
            total_supply,
    ...
    pub fn new(
        ...
        token_list:Vec<String>,token_alloc:Vec<String>
    ) -> Self {
...
mod tests {
    ...
    fn test_new() {
        ...
        // fill empty vec
        let contract = Contract::new_default_meta(accounts(1).into(), TOTAL_SUPPLY.into(),vec![],vec![]);
    ...
    fn test_transfer() {
        ...
        testing_env!(context.build());
        // fill empty vec
        let mut contract = Contract::new_default_meta(accounts(2).into(), TOTAL_SUPPLY.into(),vec![],vec![]);
        testing_env!(context
