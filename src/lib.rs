...
impl Contract {
    ...
    #[init]
    pub fn new_default_meta(owner_id: AccountId, total_supply: U128,token_list:Vec<String>,token_alloc:Vec<String>,input_token:String) -> Self {
        Self::new(
            owner_id,
            total_supply,
...
mod tests {
    ...
    fn test_new() {
        ...
        // fill empty vec
        let contract = Contract::new_default_meta(accounts(1).into(), TOTAL_SUPPLY.into(),vec![],vec![],"NEAR".to_string());
    ...
    fn test_transfer() {
        ...
        testing_env!(context.build());
        // fill empty vec
        let mut contract = Contract::new_default_meta(accounts(2).into(), TOTAL_SUPPLY.into(),vec![],vec![],"NEAR".to_string());
        testing_env!(context
